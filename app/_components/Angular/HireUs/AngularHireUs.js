...
const AngularHireUs = ({ cmsContent }) => {
  ...
  const line1 = getCmsVal(cmsContent, defaultLine1, "angularhireus");
  const line2 = getCmsVal(cmsContent, defaultLine2, "angularhireus");
