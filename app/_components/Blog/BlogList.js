...
import SeoAuditMatterImg from '../../../components/Images/blogabout.png'
...
const SeoAuditContent = () => {
  ...
  Why SEO Audit Matters
                        ...
                        <div className="space-y-6 text-gray-600 text-[16px] leading-[25px] text-justify">
                            <p>
                                Quick Summary: What to check before hiring a web agency? Before hiring a web development agency, you must evaluate their technical expertise, portfolio relevance, and...
                            </p>
                            <p>
