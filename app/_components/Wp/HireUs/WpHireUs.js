...
const WpHireUs = ({ cmsContent }) => {
  ...
  const line1 = getCmsVal(cmsContent, defaultLine1, "wphireus");
  const line2 = getCmsVal(cmsContent, defaultLine2, "wphireus");
