...
const MetaHireUs = ({ cmsContent }) => {
  ...
  const line1 = getCmsVal(cmsContent, defaultLine1, "metahireus");
  const line2 = getCmsVal(cmsContent, defaultLine2, "metahireus");
