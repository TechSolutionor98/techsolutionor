...
const PhpHireUs = ({ cmsContent }) => {
  ...
  const line1 = getCmsVal(cmsContent, defaultLine1, "phphireus");
  const line2 = getCmsVal(cmsContent, defaultLine2, "phphireus");
