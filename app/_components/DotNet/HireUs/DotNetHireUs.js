...
const DotNetHireUs = ({ cmsContent }) => {
  ...
  const line1 = getCmsVal(cmsContent, defaultLine1, "nethireus");
  const line2 = getCmsVal(cmsContent, defaultLine2, "nethireus");
