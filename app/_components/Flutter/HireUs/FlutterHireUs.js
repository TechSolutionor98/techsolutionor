...
const FlutterHireUs = ({ cmsContent }) => {
  ...
  const line1 = getCmsVal(cmsContent, defaultLine1, "flutterhireus");
  const line2 = getCmsVal(cmsContent, defaultLine2, "flutterhireus");
