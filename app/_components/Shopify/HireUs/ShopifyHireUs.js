...
const ShopifyHireUs = ({ cmsContent }) => {
  ...
  const line1 = getCmsVal(cmsContent, defaultLine1, "shopifyhireus");
  const line2 = getCmsVal(cmsContent, defaultLine2, "shopifyhireus");
