...
const FigmaHireUs = ({ cmsContent }) => {
  ...
  const line1 = getCmsVal(cmsContent, defaultLine1, "figmahireus");
  const line2 = getCmsVal(cmsContent, defaultLine2, "figmahireus");
