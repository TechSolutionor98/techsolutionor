...
const SwiftHireUs = ({ cmsContent }) => {
  ...
  const line1 = getCmsVal(cmsContent, defaultLine1, "swifthireus");
  const line2 = getCmsVal(cmsContent, defaultLine2, "swifthireus");
