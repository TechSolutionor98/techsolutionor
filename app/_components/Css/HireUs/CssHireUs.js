...
const CssHireUs = ({ cmsContent }) => {
  ...
  const line1 = getCmsVal(cmsContent, defaultLine1, "csshireus");
  const line2 = getCmsVal(cmsContent, defaultLine2, "csshireus");
