...
const MagentoHireUs = ({ cmsContent }) => {
  ...
  const line1 = getCmsVal(cmsContent, defaultLine1, "magentohireus");
  const line2 = getCmsVal(cmsContent, defaultLine2, "magentohireus");
