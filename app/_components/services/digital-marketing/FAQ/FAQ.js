...
const defaultFaqsDigitalMarketing = [
...
export default function DigitalMarketingFAQ({ cmsContent }) {
  const title = getCmsVal(cmsContent, "Frequently Asked Questions (FAQs)", "digitalmarketingfaq");
  const faqs = defaultFaqsDigitalMarketing.map((faq) => ({
    question: getCmsVal(cmsContent, faq.question, "digitalmarketingfaq"),
    answer: getCmsVal(cmsContent, faq.answer, "digitalmarketingfaq"),
  }));
