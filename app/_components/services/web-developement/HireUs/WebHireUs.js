...
const WebHireUs = ({ cmsContent }) => {
  const line1 = getCmsVal(cmsContent, defaultHireUsData.line1, "webhireus");
  const line2 = getCmsVal(cmsContent, defaultHireUsData.line2, "webhireus");

  return <HireUs line1={line1} line2={line2} />;
};

export default WebHireUs;
