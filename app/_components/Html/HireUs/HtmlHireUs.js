...
const HtmlHireUs = ({ cmsContent }) => {
  ...
  const line1 = getCmsVal(cmsContent, defaultLine1, "htmlhireus");
  const line2 = getCmsVal(cmsContent, defaultLine2, "htmlhireus");
