...
const AnalyticsHireUs = ({ cmsContent }) => {
  ...
  const line1 = getCmsVal(cmsContent, defaultLine1, "analyticshireus");
  const line2 = getCmsVal(cmsContent, defaultLine2, "analyticshireus");
...
export default AnalyticsHireUs;
