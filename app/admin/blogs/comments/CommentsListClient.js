  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm transition-all duration-300">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl mx-4 overflow-hidden border border-gray-105 flex flex-col transform transition-transform duration-300 scale-100 text-gray-900">
        {/* Header */}
        <div className="bg-[#41b349] px-6 py-5 flex items-center justify-between">
        ...
        <div className="p-6 space-y-6 flex-1 text-left">
          {/* Metadata info card */}
          <div className="bg-[#41b349]/5 rounded-xl border border-[#41b349]/20 p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1">
              <span className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider">Comment Author</span>
              <div className="flex items-center gap-2 mt-1">
                <div className="w-8 h-8 bg-[#41b349] text-white rounded-full flex items-center justify-center font-bold text-sm">
            ...
            <div className="space-y-1 border-t md:border-t-0 md:border-l border-gray-200/60 pt-3 md:pt-0 md:pl-4">
              ...
              <p className="text-sm font-semibold text-gray-900 line-clamp-2 leading-tight mt-1" title={comment.blogTitle}>
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              rows={8}
              className="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#41b349]/50 focus:border-[#41b349] transition bg-gray-50/30 focus:bg-white resize-y min-h-[160px]"
        ...
        <div className="px-6 py-4 bg-gray-50/80 border-t border-gray-105 flex gap-3 justify-end">
          <button
            type="button"
            onClick={onClose}
            className="px-5 py-2.5 border border-gray-300 rounded-lg text-sm text-gray-600 hover:bg-gray-100 transition cursor-pointer font-semibold"
          >
            Cancel
          </button>
          <button
            ...
            className="px-6 py-2.5 bg-[#41b349] hover:bg-black text-white rounded-lg text-sm font-bold transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
          >
    ...
    <div className="w-full flex flex-col min-h-[500px]">
      ...
      <div className="overflow-x-auto w-full rounded-xl border border-gray-150 shadow-sm">
        <table className="min-w-full text-sm">
          <thead>
            <tr className="bg-[#41b349] text-white text-left font-semibold">
