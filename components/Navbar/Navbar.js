...
//   { Image: SocialMedia, label: "Social Media", href: "/services/SocialMedia" },
//   { Image: Digital, label: "Digital Marketing", href: "/services/digital-marketing" },
//   { Image: Ppc, label: "PPC & Amazon", href: "/services/ppc-amazon-ads" },
...
//       {/* Desktop Navbar */}
//       <nav
//         className="bg-[#262323] w-full h-[90px] flex items-center justify-between px-10 lg:px-12 lg:pl-2 py-10"
//         style={{ boxShadow: "0px 5px 15px 0px #262323" }}
//       >
//         <div className="navbar-logo lg:pl-30">
//           <Link href="/Home">
//             <Image
//               src={Logo}
//               alt="Logo"
...
//                   <Link 
//                     href='/technologies'
//                     className={`cursor-pointer text-[15px] px-3 py-2 flex items-center gap-1 transition-colors duration-200 hover:text-[#41B349] ${isActive(link) ? "text-[#41B349]" : "text-white"}`}
//                   >
//                     {link.label}
//                     <FaChevronDown className="ml-1 text-xs mt-1" />
//                   </Link>
...
//                         <div
//                           key={i}
//                           className="border-l-2 border-l-[#41B349] px-2"
//                         >
//                           <a
//                             key={sub.label}
//                             href={sub.href}
...
//                             </div>
//                             <span
//                               className={`font-semibold text-lg ${pathname === sub.href ? "text-[#41B349]" : "text-black"}`}
//                             >
//                               {sub.label}
//                             </span>
//                           </a>
...
//                 <>
//                   <span
//                     className={`cursor-pointer px-3 py-2 flex items-center gap-1 transition-colors duration-200 hover:text-[#41B349] ${isActive(link) ? "text-[#41B349]" : "text-white"}`}
//                   >
//                     {link.label}
//                     <FaChevronDown className="ml-1 text-xs mt-1" />
//                   </span>
...
//                         key={sub.label}
//                         href={sub.href}
//                         className={`block px-4 py-2 transition-colors duration-200 hover:text-[#41B349] hover:bg-gray-700 ${pathname === sub.href ? "text-[#41B349]" : "text-white"}`}
//                       >
//                         {sub.label}
//                       </a>
//                     ))}
...
//                 <a
//                   href={link.href}
//                   className={`px-3 py-2 transition-colors duration-200 hover:text-[#41B349] ${isActive(link) ? "text-[#41B349]" : "text-white"}`}
//                 >
//                   {link.label}
//                 </a>
//               )}
...
//           ))}
//         </div>
//         <div className="hidden lg:flex navbar-buttons items-center lg:pr-30 gap-4">
//           <Link href='/pos-development'>
//           <button className="bg-[#41B349] text-white text-[15px] font-medium w-[104px] h-[39px] rounded-[20px] hover:bg-white hover:text-black transition ease-in-out duration-200 cursor-pointer">
//             Get POS
//           </button>
//           </Link>
//           <button
...
//       {/* Mobile Navbar Overlay */}
//       <div
//         className={`fixed inset-0 z-50 transition-all duration-300 ${mobileOpen ? "translate-x-0 opacity-100 visible" : "-translate-x-full opacity-0 invisible"}`}
//         style={{ background: "#262323" }}
//       >
//         <div className="flex items-center justify-between px-6 py-6">
...
//                 <Link
//                   href={link.href}
//                   className={`text-white text-lg py-3 px-2 rounded hover:bg-[#41B349]/20 transition-colors duration-200 ${pathname === link.href ? "text-[#41B349]" : "text-white"}`}
//                   onClick={() => setMobileOpen(false)}
//                 >
//                   {link.label}
//                 </Link>
...
// // MobileDropdown component for smooth dropdown transition
// function MobileDropdown({ label, subLinks, setMobileOpen, pathname }) {
//   const [open, setOpen] = useState(false);
//   return (
//     <div>
//       <button
...
//         <div className="w-[40px] h-[20px] rounded-[10px] border flex items-center justify-center">
//           <FaChevronDown
//             className={` ml-0 text-xs transition-transform duration-300 ${open ? "rotate-180" : ""}`}
//           />
//         </div>
//       </button>
//       <div
...
//               key={sub.label}
//               href={sub.href}
//               className={`text-white text-base py-2 px-2 rounded hover:bg-[#41B349]/20 transition-colors duration-200 ${pathname === sub.href ? "text-[#41B349]" : "text-white"}`}
//               onClick={() => setMobileOpen(false)}
//             >
//               {sub.label}
//             </Link>
