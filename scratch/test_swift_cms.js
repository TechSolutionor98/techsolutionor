...
const filePath = path.join(__dirname, '../app/technologies/swift/page.js');
const sections = parsePageContent(filePath, '/technologies/swift');

console.log(`Found ${sections.length} sections for /technologies/swift:\n`);
