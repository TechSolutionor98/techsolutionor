...
const filePath = path.join(__dirname, '../app/technologies/analytics/page.js');
const sections = parsePageContent(filePath, '/technologies/analytics');

console.log(`Found ${sections.length} sections for /technologies/analytics:\n`);
