...
const filePath = path.join(__dirname, '../app/technologies/flutter/page.js');
const sections = parsePageContent(filePath, '/technologies/flutter');

console.log(`Found ${sections.length} sections for /technologies/flutter:\n`);
