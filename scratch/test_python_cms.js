...
const filePath = path.join(__dirname, '../app/technologies/python/page.js');
const sections = parsePageContent(filePath, '/technologies/python');

console.log(`Found ${sections.length} sections for /technologies/python:\n`);
