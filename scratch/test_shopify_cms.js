...
const filePath = path.join(__dirname, '../app/technologies/shopify/page.js');
const sections = parsePageContent(filePath, '/technologies/shopify');

console.log(`Found ${sections.length} sections for /technologies/shopify:\n`);
