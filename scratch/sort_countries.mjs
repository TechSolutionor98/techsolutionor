...
// Filter out "Other Country", sort the rest alphabetically A-Z by name, then append "Other Country"
const otherCountry = countriesData.find(c => c.name === 'Other Country') || {
  name: "Other Country",
  iso: "XX",
  code: "+",
  minDigits: 7,
...
export const COUNTRY_DIAL_CODES = ${JSON.stringify(sortedCountries, null, 2)};
...
console.log(`Updated lib/country-phone.js with ${sortedCountries.length} sorted countries.`);
