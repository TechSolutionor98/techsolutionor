...
const filePath = path.join(__dirname, '../app/technologies/meta/page.js');
const sections = parsePageContent(filePath, '/technologies/meta');

console.log(`Found ${sections.length} sections for /technologies/meta:\n`);
