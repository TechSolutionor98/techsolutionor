...
const filePath = path.join(__dirname, '../app/services/page.js');
const sections = parsePageContent(filePath, '/services');

console.log(`Found ${sections.length} sections for /services:\n`);
