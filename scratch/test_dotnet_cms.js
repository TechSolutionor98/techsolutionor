...
const filePath = path.join(__dirname, '../app/technologies/dotnet/page.js');
const sections = parsePageContent(filePath, '/technologies/dotnet');

console.log(`Found ${sections.length} sections for /technologies/dotnet:\n`);
