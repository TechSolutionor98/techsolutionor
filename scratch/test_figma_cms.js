...
const filePath = path.join(__dirname, '../app/technologies/figma/page.js');
const sections = parsePageContent(filePath, '/technologies/figma');

console.log(`Found ${sections.length} sections for /technologies/figma:\n`);
