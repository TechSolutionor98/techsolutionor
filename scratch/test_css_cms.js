...
const filePath = path.join(__dirname, '../app/technologies/css/page.js');
const sections = parsePageContent(filePath, '/technologies/css');

console.log(`Found ${sections.length} sections for /technologies/css:\n`);
