...
const filePath = path.join(__dirname, '../app/technologies/angular/page.js');
const sections = parsePageContent(filePath, '/technologies/angular');

console.log(`Found ${sections.length} sections for /technologies/angular:\n`);
