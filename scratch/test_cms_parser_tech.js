...
const filePath = path.join(__dirname, '../app/technologies/page.js');
const sections = parsePageContent(filePath, '/technologies');

console.log(`Found ${sections.length} sections for /technologies:\n`);
