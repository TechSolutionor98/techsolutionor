...
async function main() {
  console.log('=== Scanning routes in MongoDB ===');
  const routes = await scanRoutes();
  console.log('Total active routes scanned:', routes.length);
  const graphicDesignRoute = routes.find(r => r.path === '/services/graphic-design');
  console.log('Graphic Design route entry:', graphicDesignRoute);

  const routeUrl = '/services/graphic-design';
