...
const filePath = path.join(__dirname, '../app/technologies/html/page.js');
const sections = parsePageContent(filePath, '/technologies/html');

console.log(`Found ${sections.length} sections for /technologies/html:\n`);
