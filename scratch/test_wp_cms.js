...
const filePath = path.join(__dirname, '../app/technologies/wordpress/page.js');
const sections = parsePageContent(filePath, '/technologies/wordpress');

console.log(`Found ${sections.length} sections for /technologies/wordpress:\n`);
