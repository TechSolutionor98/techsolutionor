...
export function wrapWithTechSolutionorTemplate({
  ...
  const signatureHtml = includeSignature
    ? `
      <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top: 32px; padding-top: 24px; border-top: 1px solid #e2e8f0;">
        <tr>
          <td>
            ...
            <p style="margin: 0 0 6px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size: 13px; font-weight: 600; color: #41B349;">
              Tech Solutionor &bull; Global Digital Solutions
            </p>
            <p style="margin: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size: 12px; color: #64748b; line-height: 1.5;">
              <a href="mailto:hr@techsolutionor.com" style="color: #41B349; text-decoration: none; font-weight: 600;">hr@techsolutionor.com</a>
              &nbsp;&bull;&nbsp;
              <a href="https://techsolutionor.com" style="color: #41B349; text-decoration: none; font-weight: 600;">techsolutionor.com</a>
            </p>
          </td>
        </tr>
      </table>
