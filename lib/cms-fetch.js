...
export async function generateCmsMetadata(path, defaults = {}) {
  ...
  if (!seo) {
    // If SEO data was removed or not configured in Admin Side,
    // return base site metadata so no hard-coded page-specific SEO lingers on client side
    return {
      title: "Tech Solutionor",
      description: "Tech Solutionor Technical Services and Engineering Solutions.",
    };
  }

  const baseTitle = "Tech Solutionor";
  const baseDesc = "Tech Solutionor Technical Services and Engineering Solutions.";
