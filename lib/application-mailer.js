...
export async function sendApplicationStatusNotification({ application, status, note = '' }) {
                ...
                <tr>
                  <td style="padding: 36px 32px;">
                    ...
                    <p style="font-size: 15px; line-height: 1.7; color: #475569; margin: 0 0 20px 0;">
                      We are thrilled to let you know that our recruitment team has reviewed your application and portfolio for the 
  ...
  try {
    ...
    const info = await transporter.sendMail({
      ...
      text: isApproved
        ? `Dear ${applicantName},\n\nCongratulations! Your application for the ${position} role at ${companyName} has been APPROVED for the next step. Our talent team will be in touch with you shortly.\n\nBest regards,\n${companyName}`
        : `Dear ${applicantName},\n\nThank you for applying for the ${position} role at ${companyName}. At this time, we have decided to move forward with other candidates. We will keep your resume in our talent pool for future openings.\n\nBest regards,\n${companyName}`,
    });
