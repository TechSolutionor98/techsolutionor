  ...
  try {
    ...
    for (const entry of entries) {
      ...
      if (
        ...
        (folderName === '[slug]' && basePath === '') ||
        (folderName === '[slug]' && basePath === '/blog') ||
        (folderName === '[slug]' && basePath === '/technologies') ||
        (folderName === 'reactjs' && basePath === '/technologies') ||
        (folderName === 'hire-us' && basePath === '/services') ||
